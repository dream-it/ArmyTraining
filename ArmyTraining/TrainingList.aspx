            ...
            <asp:Repeater runat="server" ID="rptCourses" Visible="false" OnItemDataBound="ItemData_Bound">
                <HeaderTemplate>
                    <div>
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                <td style="width: 5%; border-bottom: solid 1px #777777; padding-left: 10px" class="Header">
                                    ID
                                </td>
                                <td style="width: 25%; border-bottom: solid 1px #777777;" class="Header ItemPaddingStyle">
                                    Course
                                </td>
                                ...
                                <td style="width: 10%; border-bottom: solid 1px #777777; text-align: center;" class="Header ItemPaddingStyle">
                                    StartDate
                                </td>
                                <td style="width: 10%; border-bottom: solid 1px #777777; text-align: center;" class="Header ItemPaddingStyle">
                                    EndDate
